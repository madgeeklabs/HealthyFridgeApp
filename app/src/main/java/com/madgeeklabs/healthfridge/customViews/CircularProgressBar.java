package com.madgeeklabs.healthfridge.customViews;
...
public class CircularProgressBar extends Drawable {
    ...
    public static class CircularProgressBarState extends ConstantState {
        ...
        public Drawable newDrawable() {
            return new CircularProgressBar(this);
        }
    ...
    private CircularProgressBar(CircularProgressBarState state) {
